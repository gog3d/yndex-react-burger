...
import styles from './burger-ingredients-header-container.module.css';
import {Tab} from '@ya.praktikum/react-developer-burger-ui-components';

const BurgerIngredientsHeaderContainer = (props) => {
  const [current, setCurrent] = React.useState('Булки');
  return (
    <div className={styles['burger-ingredients-header-container']}>
